...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(38770776076331744953)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770776659600744953)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770777094956744953)
,p_page_template_id=>wwv_flow_imp.id(38770776076331744953)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770777552184744953)
,p_page_template_id=>wwv_flow_imp.id(38770776076331744953)
