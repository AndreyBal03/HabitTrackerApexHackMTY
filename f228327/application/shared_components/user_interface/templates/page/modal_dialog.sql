...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(38770762651797744948)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770763261341744948)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770763569521744948)
,p_page_template_id=>wwv_flow_imp.id(38770762651797744948)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770764134463744949)
,p_page_template_id=>wwv_flow_imp.id(38770762651797744948)
