...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(38770728368206744934)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770729011193744934)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770729696024744934)
,p_page_template_id=>wwv_flow_imp.id(38770728368206744934)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770730003065744935)
,p_page_template_id=>wwv_flow_imp.id(38770728368206744934)
