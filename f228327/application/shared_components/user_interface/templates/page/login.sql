...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(38770746141804744942)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770746893743744942)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770747216087744942)
,p_page_template_id=>wwv_flow_imp.id(38770746141804744942)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770747803787744943)
,p_page_template_id=>wwv_flow_imp.id(38770746141804744942)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770748228157744943)
,p_page_template_id=>wwv_flow_imp.id(38770746141804744942)
,p_name=>'Body Footer'
