...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38770786756982744956)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770787391139744956)
,p_plug_template_id=>wwv_flow_imp.id(38770786756982744956)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770787836824744956)
,p_plug_template_id=>wwv_flow_imp.id(38770786756982744956)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770788363802744957)
,p_plug_template_id=>wwv_flow_imp.id(38770786756982744956)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770788780967744957)
,p_plug_template_id=>wwv_flow_imp.id(38770786756982744956)
,p_name=>'Sub Regions'
