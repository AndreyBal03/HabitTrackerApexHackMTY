...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38770888768834744984)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770889058261744984)
,p_plug_template_id=>wwv_flow_imp.id(38770888768834744984)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770889371062744985)
,p_plug_template_id=>wwv_flow_imp.id(38770888768834744984)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770889617455744985)
,p_plug_template_id=>wwv_flow_imp.id(38770888768834744984)
,p_name=>'Button Start'
