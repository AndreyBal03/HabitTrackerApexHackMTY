...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38770891258561744986)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770891591966744986)
,p_plug_template_id=>wwv_flow_imp.id(38770891258561744986)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770891856192744986)
,p_plug_template_id=>wwv_flow_imp.id(38770891258561744986)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770892118207744986)
,p_plug_template_id=>wwv_flow_imp.id(38770891258561744986)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770892456371744986)
,p_plug_template_id=>wwv_flow_imp.id(38770891258561744986)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770892704104744986)
,p_plug_template_id=>wwv_flow_imp.id(38770891258561744986)
,p_name=>'Sub Regions'
