...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38770798879006744959)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770799318619744960)
,p_plug_template_id=>wwv_flow_imp.id(38770798879006744959)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770799982162744960)
,p_plug_template_id=>wwv_flow_imp.id(38770798879006744959)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770800395547744960)
,p_plug_template_id=>wwv_flow_imp.id(38770798879006744959)
,p_name=>'Sub Regions'
