...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38770846481231744972)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770847213934744972)
,p_plug_template_id=>wwv_flow_imp.id(38770846481231744972)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770847705279744972)
,p_plug_template_id=>wwv_flow_imp.id(38770846481231744972)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770848299271744972)
,p_plug_template_id=>wwv_flow_imp.id(38770846481231744972)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770848842519744973)
,p_plug_template_id=>wwv_flow_imp.id(38770846481231744972)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770849351366744973)
,p_plug_template_id=>wwv_flow_imp.id(38770846481231744972)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
