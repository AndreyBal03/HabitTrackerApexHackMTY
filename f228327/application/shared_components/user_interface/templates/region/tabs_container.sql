...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38770906217157744993)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770906575933744993)
,p_plug_template_id=>wwv_flow_imp.id(38770906217157744993)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770906897481744993)
,p_plug_template_id=>wwv_flow_imp.id(38770906217157744993)
,p_name=>'Tabs'
