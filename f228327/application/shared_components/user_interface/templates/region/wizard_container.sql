...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38770913971379744996)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770914274707744996)
,p_plug_template_id=>wwv_flow_imp.id(38770913971379744996)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770914545027744996)
,p_plug_template_id=>wwv_flow_imp.id(38770913971379744996)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770914816183744996)
,p_plug_template_id=>wwv_flow_imp.id(38770913971379744996)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770915155024744997)
,p_plug_template_id=>wwv_flow_imp.id(38770913971379744996)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770915411435744997)
,p_plug_template_id=>wwv_flow_imp.id(38770913971379744996)
