...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38770893718205744987)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770894035768744987)
,p_plug_template_id=>wwv_flow_imp.id(38770893718205744987)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770894377257744987)
,p_plug_template_id=>wwv_flow_imp.id(38770893718205744987)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770894631366744987)
,p_plug_template_id=>wwv_flow_imp.id(38770893718205744987)
,p_name=>'Sub Regions'
