...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38770853074318744974)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770853596088744974)
,p_plug_template_id=>wwv_flow_imp.id(38770853074318744974)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770854145137744974)
,p_plug_template_id=>wwv_flow_imp.id(38770853074318744974)
,p_name=>'Sub Regions'
