...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38770886604003744983)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770886980446744984)
,p_plug_template_id=>wwv_flow_imp.id(38770886604003744983)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770887204239744984)
,p_plug_template_id=>wwv_flow_imp.id(38770886604003744983)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770887577802744984)
,p_plug_template_id=>wwv_flow_imp.id(38770886604003744983)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770887827241744984)
,p_plug_template_id=>wwv_flow_imp.id(38770886604003744983)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770888126716744984)
,p_plug_template_id=>wwv_flow_imp.id(38770886604003744983)
,p_name=>'Sub Regions'
