...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38770789167282744957)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770789602354744957)
,p_plug_template_id=>wwv_flow_imp.id(38770789167282744957)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770790287311744957)
,p_plug_template_id=>wwv_flow_imp.id(38770789167282744957)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770790572752744957)
,p_plug_template_id=>wwv_flow_imp.id(38770789167282744957)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38770791047679744957)
,p_plug_template_id=>wwv_flow_imp.id(38770789167282744957)
,p_name=>'Sub Regions'
